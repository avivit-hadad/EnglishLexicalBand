...
import { HomePage, VocabularyDashboardPage } from './pages/HomePage';
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/vocabulary/:vocabularyId" element={<ProtectedRoute><VocabularyDashboardPage /></ProtectedRoute>} />
      ...
      <Route path="/learned" element={<ProtectedRoute><LearnedWordsPage /></ProtectedRoute>} />
